...
func newProcessInstance(db *gorm.DB, opts ...gen.DOOption) processInstance {
	...
	_processInstance.processInstanceDo.UseModel(&quote_manage.ProcessInstance{})

	tableName := _processInstance.processInstanceDo.TableName()
	_processInstance.ALL = field.NewAsterisk(tableName)
	_processInstance.ID = field.NewInt32(tableName, "id")
	_processInstance.QuoteID = field.NewInt32(tableName, "quote_id")
	_processInstance.ProcessID = field.NewInt32(tableName, "process_id")
...
func (p *processInstance) updateTableName(table string) *processInstance {
	...
	p.QuoteID = field.NewInt32(table, "quote_id")
...
type IProcessInstanceDo interface {
	...
	Create(values ...*quote_manage.ProcessInstance) error
	CreateInBatches(values []*quote_manage.ProcessInstance, batchSize int) error
	Save(values ...*quote_manage.ProcessInstance) error
	First() (*quote_manage.ProcessInstance, error)
	Take() (*quote_manage.ProcessInstance, error)
	Last() (*quote_manage.ProcessInstance, error)
	Find() ([]*quote_manage.ProcessInstance, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*quote_manage.ProcessInstance, err error)
	FindInBatches(result *[]*quote_manage.ProcessInstance, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*quote_manage.ProcessInstance) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*quote_manage.ProcessInstance, error)
	FirstOrCreate() (*quote_manage.ProcessInstance, error)
	FindByPage(offset int, limit int) (result []*quote_manage.ProcessInstance, count int64, err error)
...
func (p processInstanceDo) Create(values ...*quote_manage.ProcessInstance) error {
	if len(values) == 0 {
		return nil
	}
...
func (p processInstanceDo) CreateInBatches(values []*quote_manage.ProcessInstance, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p processInstanceDo) Save(values ...*quote_manage.ProcessInstance) error {
	if len(values) == 0 {
		return nil
	}
...
func (p processInstanceDo) First() (*quote_manage.ProcessInstance, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*quote_manage.ProcessInstance), nil
	}
}

func (p processInstanceDo) Take() (*quote_manage.ProcessInstance, error) {
...
func (p processInstanceDo) Last() (*quote_manage.ProcessInstance, error) {
...
func (p processInstanceDo) Find() ([]*quote_manage.ProcessInstance, error) {
	result, err := p.DO.Find()
	return result.([]*quote_manage.ProcessInstance), err
}

func (p processInstanceDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*quote_manage.ProcessInstance, err error) {
	buf := make([]*quote_manage.ProcessInstance, 0, batchSize)
...
func (p processInstanceDo) FindInBatches(result *[]*quote_manage.ProcessInstance, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p processInstanceDo) FirstOrInit() (*quote_manage.ProcessInstance, error) {
...
func (p processInstanceDo) FirstOrCreate() (*quote_manage.ProcessInstance, error) {
...
func (p processInstanceDo) FindByPage(offset int, limit int) (result []*quote_manage.ProcessInstance, count int64, err error) {
...
func (p processInstanceDo) Delete(models ...*quote_manage.ProcessInstance) (result gen.ResultInfo, err error) {
