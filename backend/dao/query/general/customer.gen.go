...
func newCustomer(db *gorm.DB, opts ...gen.DOOption) customer {
	...
	_customer.customerDo.UseModel(&general.Customer{})
	...
	_customer.ContactTitle = field.NewString(tableName, "contact_title")
...
func (c *customer) updateTableName(table string) *customer {
	...
	c.ContactTitle = field.NewString(table, "contact_title")
...
func (c *customer) fillFieldMap() {
	...
	c.fieldMap["contact_title"] = c.ContactTitle
}
...
type ICustomerDo interface {
	...
	Create(values ...*general.Customer) error
	CreateInBatches(values []*general.Customer, batchSize int) error
	Save(values ...*general.Customer) error
	First() (*general.Customer, error)
	Take() (*general.Customer, error)
	Last() (*general.Customer, error)
	Find() ([]*general.Customer, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*general.Customer, err error)
	FindInBatches(result *[]*general.Customer, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*general.Customer) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*general.Customer, error)
	FirstOrCreate() (*general.Customer, error)
	FindByPage(offset int, limit int) (result []*general.Customer, count int64, err error)
...
func (c customerDo) Create(values ...*general.Customer) error {
	if len(values) == 0 {
		return nil
	}
...
func (c customerDo) CreateInBatches(values []*general.Customer, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c customerDo) Save(values ...*general.Customer) error {
	if len(values) == 0 {
		return nil
	}
...
func (c customerDo) First() (*general.Customer, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*general.Customer), nil
	}
}

func (c customerDo) Take() (*general.Customer, error) {
...
func (c customerDo) Last() (*general.Customer, error) {
...
func (c customerDo) Find() ([]*general.Customer, error) {
	result, err := c.DO.Find()
	return result.([]*general.Customer), err
}

func (c customerDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*general.Customer, err error) {
	buf := make([]*general.Customer, 0, batchSize)
...
func (c customerDo) FindInBatches(result *[]*general.Customer, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c customerDo) FirstOrInit() (*general.Customer, error) {
...
func (c customerDo) FirstOrCreate() (*general.Customer, error) {
...
func (c customerDo) FindByPage(offset int, limit int) (result []*general.Customer, count int64, err error) {
...
func (c customerDo) Delete(models ...*general.Customer) (result gen.ResultInfo, err error) {
