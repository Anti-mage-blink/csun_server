...
func (a *account) updateTableName(table string) *account {
	...
	a.EmployeeID = field.NewInt32(table, "employee_id")
...
func (a *account) fillFieldMap() {
	...
	a.fieldMap["id"] = a.ID
	a.fieldMap["employee_id"] = a.EmployeeID
...
type IAccountDo interface {
	...
	Unscoped() IAccountDo
	Create(values ...*general.Account) error
	CreateInBatches(values []*general.Account, batchSize int) error
	Save(values ...*general.Account) error
	First() (*general.Account, error)
	Take() (*general.Account, error)
	Last() (*general.Account, error)
	Find() ([]*general.Account, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*general.Account, err error)
	FindInBatches(result *[]*general.Account, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*general.Account) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*general.Account, error)
	FirstOrCreate() (*general.Account, error)
	FindByPage(offset int, limit int) (result []*general.Account, count int64, err error)
...
func (a accountDo) Create(values ...*general.Account) error {
	if len(values) == 0 {
		return nil
	}
...
func (a accountDo) CreateInBatches(values []*general.Account, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a accountDo) Save(values ...*general.Account) error {
	if len(values) == 0 {
		return nil
	}
...
func (a accountDo) First() (*general.Account, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*general.Account), nil
	}
}

func (a accountDo) Take() (*general.Account, error) {
...
func (a accountDo) Last() (*general.Account, error) {
...
func (a accountDo) Find() ([]*general.Account, error) {
	result, err := a.DO.Find()
	return result.([]*general.Account), err
}

func (a accountDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*general.Account, err error) {
	buf := make([]*general.Account, 0, batchSize)
...
func (a accountDo) FindInBatches(result *[]*general.Account, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a accountDo) FirstOrInit() (*general.Account, error) {
...
func (a accountDo) FirstOrCreate() (*general.Account, error) {
...
func (a accountDo) FindByPage(offset int, limit int) (result []*general.Account, count int64, err error) {
...
func (a accountDo) Delete(models ...*general.Account) (result gen.ResultInfo, err error) {
