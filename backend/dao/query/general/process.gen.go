...
func newProcess(db *gorm.DB, opts ...gen.DOOption) process {
	...
	_process.processDo.UseModel(&general.Process{})
...
type IProcessDo interface {
	...
	Unscoped() IProcessDo
	Create(values ...*general.Process) error
	CreateInBatches(values []*general.Process, batchSize int) error
	Save(values ...*general.Process) error
	First() (*general.Process, error)
	Take() (*general.Process, error)
	Last() (*general.Process, error)
	Find() ([]*general.Process, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*general.Process, err error)
	FindInBatches(result *[]*general.Process, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*general.Process) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*general.Process, error)
	FirstOrCreate() (*general.Process, error)
	FindByPage(offset int, limit int) (result []*general.Process, count int64, err error)
...
func (p processDo) Create(values ...*general.Process) error {
	if len(values) == 0 {
		return nil
	}
...
func (p processDo) CreateInBatches(values []*general.Process, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p processDo) Save(values ...*general.Process) error {
	if len(values) == 0 {
		return nil
	}
...
func (p processDo) First() (*general.Process, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*general.Process), nil
	}
}

func (p processDo) Take() (*general.Process, error) {
...
func (p processDo) Last() (*general.Process, error) {
...
func (p processDo) Find() ([]*general.Process, error) {
	result, err := p.DO.Find()
	return result.([]*general.Process), err
}

func (p processDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*general.Process, err error) {
	buf := make([]*general.Process, 0, batchSize)
...
func (p processDo) FindInBatches(result *[]*general.Process, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p processDo) FirstOrInit() (*general.Process, error) {
...
func (p processDo) FirstOrCreate() (*general.Process, error) {
...
func (p processDo) FindByPage(offset int, limit int) (result []*general.Process, count int64, err error) {
...
func (p processDo) Delete(models ...*general.Process) (result gen.ResultInfo, err error) {
