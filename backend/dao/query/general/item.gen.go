...
func (i *item) updateTableName(table string) *item {
	...
	i.ItemCode = field.NewString(table, "item_code")
...
func (i *item) fillFieldMap() {
	...
	i.fieldMap["id"] = i.ID
	i.fieldMap["item_code"] = i.ItemCode
...
type IItemDo interface {
	...
	Unscoped() IItemDo
	Create(values ...*general.Item) error
	CreateInBatches(values []*general.Item, batchSize int) error
	Save(values ...*general.Item) error
	First() (*general.Item, error)
	Take() (*general.Item, error)
	Last() (*general.Item, error)
	Find() ([]*general.Item, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*general.Item, err error)
	FindInBatches(result *[]*general.Item, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*general.Item) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*general.Item, error)
	FirstOrCreate() (*general.Item, error)
	FindByPage(offset int, limit int) (result []*general.Item, count int64, err error)
...
func (i itemDo) Create(values ...*general.Item) error {
	if len(values) == 0 {
		return nil
	}
...
func (i itemDo) CreateInBatches(values []*general.Item, batchSize int) error {
	return i.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (i itemDo) Save(values ...*general.Item) error {
	if len(values) == 0 {
		return nil
	}
...
func (i itemDo) First() (*general.Item, error) {
	if result, err := i.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*general.Item), nil
	}
}

func (i itemDo) Take() (*general.Item, error) {
...
func (i itemDo) Last() (*general.Item, error) {
...
func (i itemDo) Find() ([]*general.Item, error) {
	result, err := i.DO.Find()
	return result.([]*general.Item), err
}

func (i itemDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*general.Item, err error) {
	buf := make([]*general.Item, 0, batchSize)
...
func (i itemDo) FindInBatches(result *[]*general.Item, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (i itemDo) FirstOrInit() (*general.Item, error) {
...
func (i itemDo) FirstOrCreate() (*general.Item, error) {
...
func (i itemDo) FindByPage(offset int, limit int) (result []*general.Item, count int64, err error) {
...
func (i itemDo) Delete(models ...*general.Item) (result gen.ResultInfo, err error) {
